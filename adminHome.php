...
<main>
      ...
      <div>
        <h1 class="titleA"> Welcome <?php echo ucfirst($_SESSION['userName'])?> </h1>
        <br><br>
        <h1 class="titleA">select a function</h1>
        <button class="adm"><a href="addItems.php" class="homeAnk">Add Items</a></button>
        <button class="adm"><a href="deleteItems.php" class="homeAnk">Delete Items</a></button>
        <button class="adm"><a href="viewQ.php" class="homeAnk">View Questions</a></button>
